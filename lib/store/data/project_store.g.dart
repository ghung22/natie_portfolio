...
mixin _$ProjectStore on _ProjectStore, Store {
  late final _$projectsAtom = Atom(name: '_ProjectStore.projects', context: context);
  ...
  late final _$getProjectsAsyncAction = AsyncAction('_ProjectStore.getProjects', context: context);
  ...
  late final _$uploadHardDataAsyncAction = AsyncAction('_ProjectStore.uploadHardData', context: context);
