...
mixin _$LanguageStore on _LanguageStore, Store {
  late final _$activeLanguageAtom = Atom(name: '_LanguageStore.activeLanguage', context: context);
  ...
  late final _$changingLanguageAtom = Atom(name: '_LanguageStore.changingLanguage', context: context);
  ...
  late final _$getActiveLanguageAsyncAction = AsyncAction('_LanguageStore.getActiveLanguage', context: context);
  ...
  late final _$setActiveLanguageAsyncAction = AsyncAction('_LanguageStore.setActiveLanguage', context: context);

  @override
  Future<void> setActiveLanguage(Language language) {
    return _$setActiveLanguageAsyncAction.run(() => super.setActiveLanguage(language));
  }
