...
mixin _$ThemeStore on _ThemeStore, Store {
  late final _$activeThemeAtom = Atom(
    name: '_ThemeStore.activeTheme',
    context: context,
  );
  ...
  late final _$getActiveThemeAsyncAction = AsyncAction(
    '_ThemeStore.getActiveTheme',
    context: context,
  );
  ...
  late final _$setActiveThemeAsyncAction = AsyncAction(
    '_ThemeStore.setActiveTheme',
    context: context,
  );
